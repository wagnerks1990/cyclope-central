...
ROLE_PERMISSIONS = {
    "viewer": {
        "dashboard:read", "devices:read", "alerts:read", "jobs:read", "remote:read",
        "assets:read", "documentation:read", "discovery:read", "tickets:read", "reports:read", "ai:read",
    },
    "technician": {
        "dashboard:read", "devices:read", "alerts:read", "alerts:acknowledge",
        "jobs:read", "jobs:create", "jobs:cancel", "remote:read", "remote:launch",
        "assets:read", "assets:write", "documentation:read", "discovery:read", "discovery:write",
        "tickets:read", "tickets:write", "reports:read", "ai:read",
    },
    "admin": {
        "dashboard:read", "devices:read", "alerts:read", "alerts:acknowledge",
        "jobs:read", "jobs:create", "jobs:cancel", "notifications:manage", "enrollment_tokens:manage",

    ...
    <AppShell>
      <section className="space-y-6">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
          ...
          <h1 className="mt-2 text-3xl font-bold">Assets</h1>
          <p className="mt-2 max-w-3xl text-slate-400">Track asset tags, warranties, assignments, lifecycle status, and linked managed devices.</p>
        </div>

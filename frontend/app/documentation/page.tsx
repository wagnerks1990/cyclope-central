    ...
    <AppShell>
      <section className="space-y-6">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
          ...
          <h1 className="mt-2 text-3xl font-bold">Documentation</h1>
          <p className="mt-2 max-w-3xl text-slate-400">Maintain Markdown documentation, companies, locations, procedures, diagrams, domains, and certificates without storing secrets.</p>
        </div>

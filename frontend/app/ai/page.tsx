    ...
    <AppShell>
      <section className="space-y-6">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
          ...
          <p className="mt-2 max-w-3xl text-slate-400">Ask tenant-scoped operational questions using local provider abstraction only; external LLM APIs are not enabled.</p>
        </div>
